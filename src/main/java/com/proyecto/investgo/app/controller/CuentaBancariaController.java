...
public class CuentaBancariaController {
    ...
    public ResponseEntity<?> buscar(@PathVariable String codigo, HttpServletRequest request) {
        ...
        boolean esPropietario = ctaService.validarPropietarioCuenta(idU, codigo);
        if (!esPropietario) {
    ...
    public ResponseEntity<Page<CuentaBancariaDTO>> listarUsuAct(HttpServletRequest request, Paginador paginador) {
        String idU = decoderService.getIdUser(request);
        Page<CuentaBancariaDTO> lista = ctaService.findAllByUsuarioIdDto(idU, paginador);
    ...
    public ResponseEntity<?> actualizar(@RequestBody @Valid CuentaBancaria cta, BindingResult result,
        ...
        HashMap<String, Object> salida = new HashMap<>();
        String idU = decoderService.getIdUser(request);
        boolean esPropietario = ctaService.validarPropietarioCuenta(idU, cta.getCodigo());
        if (!esPropietario) {
    ...
    public ResponseEntity<?> eliminar(@PathVariable String codigo, HttpServletRequest request) {
        HashMap<String, Object> salida = new HashMap<>();
        try {
            String idU = decoderService.getIdUser(request);
            ;
